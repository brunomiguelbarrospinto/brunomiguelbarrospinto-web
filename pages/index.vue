<template>
  <div>
    <div class="relative">
      <a
        aria-label="Home"
        class="block h-16 w-16 origin-left pointer-events-auto mb-8"
        href="/"
        ><img
          alt=""
          fetchpriority="high"
          ...
          decoding="async"
          data-nimg="1"
          class="rounded-full object-cover dark:bg-zinc-800 h-16 w-16"
      ...
      >
        Frontend developer, engineer and <br />
        ramen lover.
      </h1>

      <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
        I’m Bruno, a software frontend developer based in Barcelona city. I’m
        the frontend lead at Filmin, where we develop technologies that empower
        regular people to explore cinema world.
      </p>
      ...
      <div class="mt-6 flex gap-6">
        <a
          ...
          href="https://twitter.com/brunombarrosp"
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a
          ...
          href="https://www.instagram.com/brunomiguelbarrospinto"
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a
          ...
          href="https://github.com/brunomiguelbarrospinto"
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a
          ...
          href="https://www.linkedin.com/in/bruno-miguel-barros-pinto-25a903116"
          ><svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300"
    ...
    <div
      class="mt-24 md:mt-28 mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2"
    >
      <div>
        <PostsPostListItem v-for="post in posts" :post="post" />
      </div>
